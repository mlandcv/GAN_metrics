...
#print(score)
#print(total_score)
print("Mean of all means NIMA for all images:",sum(total_score_mean)/float(len(total_score_mean)))
print("Mean of all variances NIMA for all images:",sum(total_score_std)/float(len(total_score_std)))
